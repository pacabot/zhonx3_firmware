...
#define GYRO_T_SENSITIVITY 		9.00   //The temperature coefficient is ~9 mV/캜 at 25캜
#define GYRO_T_OUT_SENSITIVITY	(GYRO_T_SENSITIVITY*(GYRO_VRATIO/5000.00)) // ~3,564 mV/캜 at 25째C (3.3v)
...
#define STM32_T_SENSITIVITY		2.50	//The temperature coefficient is ~2.5 mV/캜 at 25캜
#define STM32_T_V25				760.00	//Voltage at 25 캜
