...
/* Global variables */
const FONT_DEF Font_3x6 = { 3, 6, 32, 96, au8Font3x6 }; //FONT_DEF is a structure, Font_System3x6 is a variable of type FONT_DEF
const FONT_DEF Font_5x8 = { 5, 8, 32, 128, au8Font5x8 };
const FONT_DEF Font_7x8 = { 7, 8, 32, 128, au8Font7x8 };
const FONT_DEF Font_8x8 = { 8, 8, 32, 128, au8Font8x8 };
const FONT_DEF Font_8x8Thin = { 8, 8, 32, 128, au8Font8x8Thin };

/* System 3x6 - UPPER CASE ONLY */
const unsigned char au8Font3x6[] = { 0x00, 0x00, 0x00, /* Space */
                                     0x00, 0x5C, 0x00, /* ! */
                                     0x0C, 0x00, 0x0C, /* " */
                                     0x7C, 0x28, 0x7C, /* # */
                                     0x7C, 0x44, 0x7C, /* 0x */
...
/* System 5x8 */
const unsigned char au8Font5x8[] = { 0x00, 0x00, 0x00, 0x00, 0x00, /* Space */
...
/* System 7x8 */
const unsigned char au8Font7x8[] = { 0, 0, 0, 0, 0, 0, 0, //' '
                                     0, 6, 95, 95, 6, 0, 0, //'!'
                                     0, 7, 7, 0, 7, 7, 0, //'"'
...
/* 8x8 Normal */
const unsigned char au8Font8x8[] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,       // ASCII -  32
...
/* 8x8 Thin */
const unsigned char au8Font8x8Thin[] = { , };
